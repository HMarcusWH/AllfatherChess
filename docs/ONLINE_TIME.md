...
ONLINE-1 refuses hybrid_authority, GPU envelopes and recursive REFINE. Converting
`clock_v1` into a bounded anchor command never makes it `movetime_v0` authority.
