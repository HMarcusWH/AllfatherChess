...
| `make refinement-tests` | `tests/controller/test_refinement.py` | deterministic VERIFY-final target nomination, exact child-index partition, shadow-only config gates, live EXPLORE→VERIFY→REFINE execution, artifact separation, descendant telemetry, and tamper refusal. |
